        ...
        <ul class="categories__list">
            <li class="categories__item category">
                <a href="/catalog/instrument">
                    <img class="category__image" src="{{ asset('img/categories_main/instrumenti_main.png') }}"
                         alt="Инструменты">
            ...
            <li class="categories__item category">
                <a href="/catalog/instrument">
                    <img class="category__image" src="{{ asset('img/categories_main/gvozdi_main.png') }}"
                         alt="Крепеж и фурнитура">
                    <p class="category__name">Крепеж и фурнитура</p>
                </a>
            </li>
            <li class="categories__item category">
                <a href="/catalog/instrument">
                    <img class="category__image" src="{{ asset('img/categories_main/generator.png') }}"
                         alt="Силовая техника">
            ...
            <li class="categories__item category">
                <a href="/catalog/instrument">
                    <img class="category__image" src="{{ asset('img/categories_main/molotok.png') }}"
    ...
    <div class="advantages__container container">
        <ul class="advantages__list">
            <li class="advantages__item advantage">
                <div class="advantage__icon"><img src="{{ asset('img/advantages-img/floor-price.svg') }}"
                                                  alt="Минимальные цены"></div>
                <h3 class="advantage__title">Минимальные цены</h3>
            </li>
            <li class="advantages__item advantage">
                <div class="advantage__icon"><img src="{{ asset('img/advantages-img/fast-delivery.svg') }}"
                                                  alt="Бесплатная доставка"></div>
                <h3 class="advantage__title">Бесплатная доставка</h3>
            </li>
            <li class="advantages__item advantage">
                <div class="advantage__icon"><img src="{{ asset('img/advantages-img/payment.svg') }}"
                                                  alt="Удобная оплата"></div>
        ...
        <ul class="services__list">
            <li class="services__item service">
                <div class="service__top-content">
                    <div class="service__icon"><img src="{{ asset('img/services/calculator.svg') }}" alt="Смета онлайн">
                    </div>
                    <div class="service__content">
                        <a href="#"><h3 class="service__name smeta">Смета онлайн</h3></a>
                        <p class="service__desc">Доставка распространяется на розничных клиентов и клиентов
                            интернет-магазина</p>
                    </div>
                </div>
            ...
            <li class="services__item service">
                <div class="service__top-content">
                    <div class="service__icon"><img src="{{ asset('img/services/shkaf.svg') }}" alt="Сборка мебели">
                    </div>
                    <div class="service__content">
            ...
            <li class="services__item service">
                <div class="service__top-content">
                    <div class="service__icon"><img src="{{ asset('img/services/instrumenti.svg') }}"
                                                    alt="Прокат инструментов"></div>
                    <div class="service__content">
            ...
            <li class="services__item service">
                <div class="service__top-content">
                    <div class="service__icon"><img src="{{ asset('img/advantages-img/fast-delivery.svg') }}"
                                                    alt="Доставка"></div>
                    <div class="service__content">
        ...
        <ul class="hits__list">
            <li class="hits__item product">
                <a href="/product_card" style="text-decoration: none;">
                    <img class="product__image" src="{{ asset('img/hits-photo/perforator.png') }}"
                         alt="Гипсокартон влагостойкий">
                    ...
                    <div class="product__actions">
                        ...
                        <span class="product__action product__action--favorite"><img
                                src="{{ asset('img/icons/heart.svg') }}" alt=""></span>
                    </div>
                </a>
            </li>
            <li class="hits__item product">
                <a href="/product_card" style="text-decoration: none;">
                    <img class="product__image" src="{{ asset('img/hits-photo/gipsokarton.png') }}"
                         alt="Гипсокартон влагостойкий">
                    <div class="product__price">
            ...
            <li class="hits__item product">
                <a href="/product_card" style="text-decoration: none;">
                    <img class="product__image" src="{{ asset('img/hits-photo/spc-plitka.webp') }}"
                         alt="SPC плитка Дуб Санкт-Петербург">
                    <div class="product__price">
            ...
            <li class="hits__item product">
                <a href="/product_card" style="text-decoration: none;">
                    <img class="product__image" src="{{ asset('img/hits-photo/ceresit.png') }}"
                         alt="Ceresit Клей для плитки эластичный">
                    <div class="product__badge product__badge--discount">-13%</div>
                    <div class="product__price">
                        <span class="product__price-current">26 640 ₽</span>
                        <span class="product__price-old">29 990 ₽</span>
            ...
            <li class="reviews__item review">
                <div class="review__header">
                    <div class="review__avatar">
                        <a href="#"><img class="review__avatar-image" src="{{ asset('img/reviews-photo/women1.jpg') }}"
                                         alt="Екатерина Холопова"></a>
                    </div>
                    <div class="review__author-rating">
                        <a href="#" style="text-decoration: none; color: black;"><h3 class="review__author">Екатерина
                                Холопова</h3></a>
                        <div class="review__rating"><img src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""></div>
                    </div>
                </div>
                <div class="review__content">
                    <p class="review__text">Я никогда раньше не сталкивалась с серьезным ремонтом, но когда решила
                        своими руками собрать шкаф и положить плитку в ванной, немного паниковала. Цены приятно удивили,
                        особенно на собственные торговые марки. А главное я поверила в свои силы. Весь купленный
                        материал был качественным, ремонт прошел без сюрпризов. Теперь только к вам!</p>
                </div>
            </li>
            <li class="reviews__item review">
                <div class="review__header">
                    <div class="review__avatar">
                        <a href="#"><img class="review__avatar-image" src="{{ asset('img/reviews-photo/women2.webp') }}"
                                         alt="Афанасия Калинова"></a>
                    </div>
                    <div class="review__author-rating">
                        <a href="#" style="text-decoration: none; color: black;"><h3 class="review__author">Афанасия
                                Калинова</h3></a>
                        <div class="review__rating"><img src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                ...
                <div class="review__content">
                    <p class="review__text">Постоянно закупаемся для объектов. Основной ассортимент всегда в наличии,
                        цены адекватные. Менеджеры работают четко. Иногда не хватает экзотики, но в целом — надежный
                        поставщик.</p>
                </div>
            </li>
            <li class="reviews__item review">
                <div class="review__header">
                    <div class="review__avatar">
                        <a href="#"><img class="review__avatar-image" src="{{ asset('img/reviews-photo/women3.jpg') }}"
                                         alt="Надежда Любознатая"></a>
                    </div>
                    <div class="review__author-rating">
                        <a href="#" style="text-decoration: none; color: black;"><h3 class="review__author">Надежда
                                Любознатая</h3></a>
                        <div class="review__rating"><img src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                                src="{{ asset('img/icons/star.svg') }}" alt=""><img
                ...
                <div class="review__content">
                    <p class="review__text">Была в вашем новом филиале на Проспекте Строителей. Все сделано для комфорта
                        покупателя! Возле каждого вида краски есть образцы на стене, можно сразу посмотреть, как цвет
                        выглядит при разном освещении. Персонал вежливый, не навязывается, но всегда готов помочь.
                        Заказали доставку — привезли в тот же день, все аккуратно разгрузили, ничего не помяли и не
                        разбили.</p>
                </div>
            </li>
        </ul>
        ...
        <div class="about__grid">
            <div class="about__left-column">
                <div class="about__card about__card--map">
                    ...
                    <img class="about__card-image" src="{{ asset('img/img-about/map.jpg') }}"
                         alt="Карта расположения магазинов">
                </div>
                ...
                <div class="about__bottom-row">
                    ...
                    <div class="about__card about__card--experience">
                        <div class="about__card-content">
                            ...
                            <p class="about__card-desc">Заботимся о наших клиентах - предлагаем низкие цены и быструю
                                доставку</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="about__right-column">
                <div class="about__card about__card--brands">
                    <div class="about__card-content">
                        ...
                        <p class="about__card-desc">Наши партнёры, представлены на нашем сайте - от экономкласса до
                            профессиональных</p>
                    </div>
                    <img class="about__card-image" src="{{ asset('img/img-about/sheterenki.jpg') }}"
                         alt="Изображение шестерёнок">
                </div>
            </div>
        </div>
    </div>
